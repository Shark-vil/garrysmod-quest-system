concommand.Add('qsystem_compile_quests', function(ply, cmd, args)
    ...
    for points_name, map_data in pairs(all_points) do
        for map_name, data in pairs(map_data) do
            ...
            create_files = create_files 
                .. "file.Write('quest_system/points/" 
                .. quest_id .. "/" .. map_name .. "/" .. points_name .. ".json', '" .. json ..  "');"
        end
    end
    ...
    for trigger_name, map_data in pairs(all_triggers) do
        create_files = create_files 
            .. "file.CreateDir('quest_system/triggers/" .. quest_id .. "/');"
        ...
        for map_name, data in pairs(map_data) do
            ...
            create_files = create_files 
                .. "file.Write('quest_system/triggers/" 
                .. quest_id .. "/" .. map_name .. "/" .. trigger_name .. ".json', '" .. json ..  "');"
        end
    end
    ...
    for structure_name, map_data in pairs(all_structure) do
        create_files = create_files 
            .. "file.CreateDir('quest_system/structure/" .. quest_id .. "/');"
        ...
        for map_name, data in pairs(map_data) do
            ...
            create_files = create_files 
                .. "file.Write('quest_system/structure/" 
                .. quest_id .. "/" .. map_name .. "/" .. structure_name .. ".json', '" .. json ..  "');"
        end
    end
    ...
    for quest_id, quest in pairs(QuestSystem:GetAllQuest()) do
        ...
        if file.Exists(point_dir_path, 'DATA') 
            or file.Exists(triggers_dir_path, 'DATA') 
            or file.Exists(structure_dir_path, 'DATA')
        then
