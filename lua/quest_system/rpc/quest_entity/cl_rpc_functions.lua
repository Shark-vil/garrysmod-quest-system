net.RegisterCallback('qsystem_rpc_function_onUse', function(_, eQuest, ent)
...
net.RegisterCallback('qsystem_rpc_function_onQuestNPCKilled', function(_, eQuest, data, npc, attacker, inflictor)
    local step = eQuest:GetQuestStepTable()
...
net.RegisterCallback('qsystem_rpc_function_onUseItem', function(_, item, activator, caller, useType, value)
